...
public record AdminStaffRequest(
    ...
    @Schema(description = "센터 ID (char(11))", example = "CTR00001234", requiredMode = RequiredMode.REQUIRED) String centerId,

    @Schema(description = "이름", example = "홍관리", requiredMode = RequiredMode.REQUIRED) String name,
    ...
    @Schema(description = "전화번호", example = "010-1234-5678", requiredMode = RequiredMode.REQUIRED) String phoneNumber,
