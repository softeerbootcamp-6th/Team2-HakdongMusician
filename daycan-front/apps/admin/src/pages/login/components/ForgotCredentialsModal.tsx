...
export const ForgotCredentialsModal = ({ isOpen, onClose }: ForgotCredentialsModalProps) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} position="top">
      <div style={{  textAlign: "center" }}>
        <Heading type="xsmall" weight={600} style={{ color: COLORS.gray[900], marginBottom: "24px" }}>
